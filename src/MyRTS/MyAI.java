 ...
 * @author santi
 */
public class MyAI extends AbstractionLayerAI {
//  UnitType: Resource(矿)，基地(Base), Barracks(兵营), Worker(采矿)，Light(移动快，生命值小，攻击力小，)，
//  Heavy(移动慢，生命值大，攻击力高)，Ranged（adc）   7种类型  矿，基地       兵营，4种兵
    Random r = new Random();
    protected UnitTypeTable utt;
    UnitType workerType;
    UnitType baseType;
    UnitType barracksType;  //兵营
    UnitType rangedType;
    UnitType lightType;
    UnitType heavyType;
    ...
    public MyAI(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }


    public MyAI(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public void baseBehavior(Unit u, Player p, PhysicalGameState pgs) {
        int nworkers = 0;
        for (Unit u2 : pgs.getUnits()) {//统计work数量
